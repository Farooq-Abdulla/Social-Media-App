        ...
        <Button variant={'ghost'} className="flex items-center justify-start gap-3" title="Notifications" asChild>
            ...
            <Link href={"/notifications"}>
                <div className="relative">
                    <Bell />
                    {!!data.unreadCount && <span className="absolute -right-1 -top-1 rounded-full bg-red-500 text-primary-foreground px-1 text-xs font-medium tabular-nums">{data.unreadCount}</span>}
                </div>
